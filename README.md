...
Note this repo only includes models for RSII and Sequel I chemistries. Recent Sequel II data should be analized with a recent version of SMRT Analysis https://www.pacb.com/support/software-downloads/
